...
   };
   if ((event.body.toLowerCase() == "কেমন আছো") || (event.body.toLowerCase() == "Kemon acho")) {
     return api.sendMessage("𝘼𝙡𝙝𝙖𝙢𝙙𝙪𝙡𝙡𝙞𝙖𝙝 𝙫𝙡𝙤__𝙩𝙢𝙞? ❤️", threadID);
   };
   if ((event.body.toLowerCase() == "আবির") || (event.body.toLowerCase() == "Abir") || (event.body.toLowerCase() == "আবির") || (event.body.toLowerCase() == "Farhan")) {
...
     return api.sendMessage("Nh ami চুপ থাকবো না.😼 abir বস আমারে কথা বলতে বলছে🤭", threadID);
   };
...
   };
   if ((event.body.toLowerCase() == "💋") || (event.body.toLowerCase() == "💋")) {
     return api.sendMessage("️ নাউজুবিল্লাহ ছি ছি আল্লাহ সবাইকে আমার ABIR BOSS এর মতো ভালো করে দাও🤨🤨", threadID);
   };
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
...
     return api.sendMessage("আরে ভাই,মাথায় বারি মারিস না,মাথা ফেটে যাবে😬", threadID);
   };
  if ((event.body.toLowerCase() == "😂") || (event.body.toLowerCase() == "😁") || (event.body.toLowerCase() == "😆") || (event.body.toLowerCase() == "😹") || (event.body.toLowerCase() == "🤣")) {
...
     return api.sendMessage("আসালামু ওয়ালাইকুম আমি আবির এর বট বলতে আছি আমি কলে আসতে পারি না", threadID);
   };
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "❤️")) {
...
   };
   if ((event.body.toLowerCase() == "আমি আবির") || (event.body.toLowerCase() == "Ami Abir")) {
