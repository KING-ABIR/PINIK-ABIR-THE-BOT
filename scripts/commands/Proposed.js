...
a("....///-- আমি আমার  বস আবিরের পক্ষে থেকে বলতাছি, ☺️💝🌺...//");
setTimeout(() => {a({body: "শুনো প্রিয় খুব ভালো বাসি তোমায় 🥰।" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "তোমার সাথে একবার কথা না বল্লে আবির বসের মনটা কেমন জানি করে☺️" + " " + name, mentions: arraytag})}, 5000);
...
setTimeout(() => {a({body: "জান তুমি এত সুন্দর কেন আবির যে তোমায় না দেখে থাকতে পারি না😻🥰💚 " + " " + name, mentions: arraytag})}, 17000);
...
setTimeout(() => {a({body: "༉༎༉😽!!লাইন টা তোমার জন্য  ডুবেছি আমি তোমার প্রেমের অনন্ত মায়ায় 🙈 ༅༎•❤️🌸" + " " + name, mentions: arraytag})},31000);
...
setTimeout(() =>{a("লাস্ট এতো টুকই বলবো থাক বেশি হইয়া গেছে\n\n𝐋𝐨𝐯𝐞 𝐅𝐫𝐨𝐦 ABIR 𝐁𝐨𝐬𝐬😻")}, 47000);
}
